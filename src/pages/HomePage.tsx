        ...
        <>
            ...
            <div className="relative flex items-start gap-7 px-5 sm:px-8 lg:px-16">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {/* ── Hero banner ── */}
                    <div className="relative my-10 min-h-[190px] overflow-hidden rounded-[14px] border border-[#E5E7EB] bg-[#C4DEDD] sm:min-h-[230px]">
                        {!bannerFailed && (
                            <img
                        ...
                        <div className="absolute inset-0 flex flex-col items-start justify-center px-6 text-left sm:px-8 lg:px-14">
                            ...
                            <button
                                ...
                                className="mt-5 rounded-[14px] bg-white px-5 py-2 text-sm font-bold text-[#437c78] transition-opacity duration-200 hover:opacity-90 epilogue-header"
                            >
                                Sign Up
                            </button>
                        </div>
